...
| Plugin update | Native update; preserves detected scope | Confirmed marketplace upgrade plus bounded remove/add | Native update after source-provenance check |
