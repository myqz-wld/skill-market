...
Before any operation, read `market.json` from the repository root and use its `registry.skills.claude`,
`registry.plugins.claude`, and `publish` fields as the source of truth.
