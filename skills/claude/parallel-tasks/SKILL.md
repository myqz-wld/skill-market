...
- Review-related subtasks must use `xhigh` reasoning when the dispatch mechanism exposes reasoning effort or thinking controls, even if the work otherwise fits a lower-effort tier. This covers review, audit, validation-review, adversarial review, plan review, prompt-asset review, and code-review subtasks.
