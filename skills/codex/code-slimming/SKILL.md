...
Use this skill to reduce code size without guessing. Run it in two phases: scan and report first, approval-gated edits second. Use `rg` / shell for inspection and `apply_patch` for manual edits.
