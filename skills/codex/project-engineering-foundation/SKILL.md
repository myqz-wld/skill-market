...
Use this skill to give or restore a repository's stable AI-coding operating model. Inspect the existing repository first, preserve project-specific invariants in project files, and keep reusable workflow rules in this skill. Use `rg` / shell for inspection and `apply_patch` for manual file edits.
