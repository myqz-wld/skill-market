...
|---|---|---|---|---|---|
| claude | complex-work-planning | 0.0.8 | skills/claude/complex-work-planning | active | Use when explicitly requested; when complex implementation or architecture work is detected before coding, ask whether to start, then resolve user-owned decisions in stages, build a durable plan, and hand off only after review. |
...
| codex | complex-work-planning | 0.0.8 | skills/codex/complex-work-planning | active | Use when explicitly requested; when complex implementation or architecture work is detected before coding, ask whether to start, then resolve user-owned decisions in stages, build a durable plan, and hand off only after review. |
