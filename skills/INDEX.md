...
| claude | diff-walkthrough | 0.0.2 | skills/claude/diff-walkthrough | active | Use when walking a user through pull-request diffs or merge-conflict resolutions one fragment at a time with explanation and confirmation before continuing. |
...
| codex | diff-walkthrough | 0.0.2 | skills/codex/diff-walkthrough | active | Use when walking a user through pull-request diffs or merge-conflict resolutions one fragment at a time with explanation and confirmation before continuing. |
