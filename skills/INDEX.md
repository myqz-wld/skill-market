...
| claude | parallel-tasks | 0.0.11 | skills/claude/parallel-tasks | active | Use when the lead already has 2+ independent tasks or work tracks with disjoint write sets. Inventories dispatch capabilities, selects mechanisms that enforce resolved routing controls, obtains batch approval, then integrates and validates results. |
...
| codex | parallel-tasks | 0.0.11 | skills/codex/parallel-tasks | active | Use when the lead already has 2+ independent tasks or work tracks with disjoint write sets. Inventories dispatch capabilities, selects mechanisms that enforce resolved routing controls, obtains batch approval, then integrates and validates results. |
...
| grok | parallel-tasks | 0.0.11 | skills/grok/parallel-tasks | active | Use when the lead already has 2+ independent tasks or work tracks with disjoint write sets. Inventories dispatch capabilities, selects mechanisms that enforce resolved routing controls, obtains batch approval, then integrates and validates results. |
