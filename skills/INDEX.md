...
| claude | project-engineering-foundation | 0.0.9 | skills/claude/project-engineering-foundation | active | Use when creating a new AI-coding repository or when an existing repository lacks the durable engineering structure (CLAUDE.md/AGENTS.md/UI_COPY_LANGUAGE.md entries, src/build layout, ref/ record indexes). |
...
| codex | project-engineering-foundation | 0.0.9 | skills/codex/project-engineering-foundation | active | Use when creating a new AI-coding repository or when an existing repository lacks the durable engineering structure (CLAUDE.md/AGENTS.md/UI_COPY_LANGUAGE.md entries, src/build layout, ref/ record indexes). |
