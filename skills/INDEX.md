...
| claude | prompt-asset-improver | 0.0.1 | skills/claude/prompt-asset-improver | active | Use before editing durable AI-facing prompt assets such as system prompts, agent instructions, SKILL.md files, MCP/tool descriptions, and long-lived prompt references. |
...
| codex | prompt-asset-improver | 0.0.1 | skills/codex/prompt-asset-improver | active | Use before editing durable AI-facing prompt assets such as system prompts, agent instructions, SKILL.md files, MCP/tool descriptions, and long-lived prompt references. |
